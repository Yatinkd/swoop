  ...
  Future<void> _createPlan() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('Plan created! 🎉'),
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              maxLines: 3,
              decoration: const InputDecoration(
                hintText: 'Describe the vibe, what to expect...',
              ),
            ),
            const SizedBox(height: 24),
              ...
              children: _vibes.map((v) {
                ...
                return GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: sel
                          ? AppColors.vibeBg(v.toLowerCase())
                          : AppColors.card,
                      borderRadius: BorderRadius.circular(24),
                      border: Border.all(
                        color: sel
                            ? AppColors.vibeFg(v.toLowerCase()).withOpacity(0.3)
                            : AppColors.divider,
                        width: sel ? 1.5 : 1,
                      ),
                      boxShadow: sel
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        color: sel
                            ? AppColors.vibeFg(v.toLowerCase())
                            : AppColors.subtle,
                        fontWeight: FontWeight.w700,
                        fontSize: 14,
                      ),
